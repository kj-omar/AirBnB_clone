...
class TestHBNBCommand(unittest.TestCase):
    ...
    def test_fs_create(self):
        """Test the create command witj file storage.
        """
    ...
    def test_db_create(self):
        ...
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
            #create model with no null attributes"
    ...
    def test_db_show(self):
        """Test the show command with database storage.
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
    ...
    def test_db_count(self):
        """Test the count command with datavase storage.
        """
        with patch('sys.stdout', new=StringIO()) as cout:
            cons = HBNBCommand()
            dbc = MySQLdb.connect(
